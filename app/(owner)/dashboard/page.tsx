  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-indigo-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-24">
        {/* Welcome Banner */}
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 mb-8 text-white border border-white/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-lg p-6 border-l-4 border-purple-500 border border-white/20">
            <div className="text-4xl mb-2">🏢</div>
            <div className="text-white/70 text-sm uppercase tracking-wide mb-1">Total Properties</div>
          ...
          <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-lg p-6 border-l-4 border-blue-500 border border-white/20">
            <div className="text-4xl mb-2">📅</div>
            <div className="text-white/70 text-sm uppercase tracking-wide mb-1">Active Bookings</div>
            <div className="text-4xl font-bold text-white">{stats.activeBookings}</div>
            <div className="text-xs text-white/50 mt-2">Current tenants</div>
          </div>

          <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-lg p-6 border-l-4 border-green-500 border border-white/20">
            <div className="text-4xl mb-2">💰</div>
            <div className="text-white/70 text-sm uppercase tracking-wide mb-1">Monthly Revenue</div>
            <div className="text-4xl font-bold text-white">₹{(stats.monthlyRevenue / 1000).toFixed(1)}K</div>
            <div className="text-xs text-white/50 mt-2">Potential earnings</div>
          </div>

          <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-lg p-6 border-l-4 border-red-500 border border-white/20">
            <div className="text-4xl mb-2">⏰</div>
            <div className="text-white/70 text-sm uppercase tracking-wide mb-1">Pending Requests</div>
            <div className="text-4xl font-bold text-white">{stats.pendingRequests}</div>
            <div className="text-xs text-white/50 mt-2">All clear</div>
          </div>
        </div>
          ...
          <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-lg p-6 mb-8 border border-white/20">
            <div className="flex justify-between items-center mb-6">
              <div>
                ...
                <p className="text-white/70">Latest property listings</p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {recentProperties.map((property) => (
                <div key={property._id} className="bg-white/5 border border-white/20 rounded-xl p-4 hover:bg-white/10 transition-all">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-white/60 text-xs">📍 {property.location?.city}</p>
                    </div>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-red-400 font-bold">₹{property.price?.toLocaleString()}/mo</span>
                    <Link href={`/properties/${property._id}/edit`}>
                      <Button size="sm" variant="outline" className="border-white/30 text-white hover:bg-white/20 text-xs">
                        Edit
                      </Button>
                    </Link>
                  </div>
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-lg p-6 mb-8 border border-white/20">
          ...
          <p className="text-white/70 mb-6">Review and respond to tenant requests</p>
          
          <div className="text-center py-12">
            <div className="text-6xl mb-4">📭</div>
            <h4 className="text-xl font-bold text-white mb-2">No Booking Requests Yet</h4>
            <p className="text-white/70">When tenants request to book your properties, they'll appear here</p>
          </div>
        </div>
